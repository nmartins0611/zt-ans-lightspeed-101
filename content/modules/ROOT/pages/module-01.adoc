...
.   **Enable the Ansible Lightspeed trial (if not already enabled):**
    * If you have an active AAP trial subscription, you'll see an option to enable the Ansible Lightspeed trial
    * Click to enable the trial
    * This step may be automatic if you've already enabled the trial
...
.   **Verify the connection:**
    * In the Ansible extension sidebar, you should see `Logged in as <your-email>`
    * A confirmation notification will appear in the bottom right corner

[TIP]
====
If you receive a timeout warning, simply click **Connect** in the Ansible extension again and repeat the authorization steps.
====
